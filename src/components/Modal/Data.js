import video1 from '../../images/gitlet-demo-fin.mov'
...
import video5 from '../../images/ctg-demo.png'
...
export const byow = {
    ...
    p4: "Applied knowledge of graphs, psudorandomness, debugging and used data sctructures such as HashMaps, priority queues, and linked lists",
    video: video2
...
export const erisc = {
    ...
    p3: "The ERISC code will read line by line looking for expressions, such as: declaration and assignment of variables, addition, substraction, multiplication, division, modulo, while loops, conditionals (and, or), and declaring and executing methods",
...
export const deques = {
    title: "Deques",
    p1: "Built using: Java",
    p2: "Two implementations of a Double Ended Queue (deque): using doubly linked Lists (with circular topology) and using arrays implementing the deque API. At the end, we used the Deque interface to implement the Karplus-Strong algorithm, and play Guitar Hero! (you can watch in my YouTube channel)",
    ...
    p4: "Applied knowledge of class polymorphism, inheritance and is data-structures heavy!"
}

export const dco = {
    title: "2048",
    p1: "Built using: Java",
    p2: "Developed the core logic behind the game: merge two tiles that are the same value, do nothing if they have different values, and lose if you have no available movements! The GUI code, handle key-presses and other methods were already implemented",
    p3: "Connected the pieces of multiple massive classes such as Tile, Board, Side and Model, in order to make the game work. This is a valuable skill when you get to work in a giant code that you didn't write, but that you have to understand first.",
