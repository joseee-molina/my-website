    ...
    <ServicesContainer id="portfolio">
      ...
      <ServicesWrapper>
        <ServicesCard onClick={openModal}>
          ...
          <ServicesP>Git-like Version Control System</ServicesP>
        </ServicesCard>
        <ServicesCard onClick={openModal}>
          <Modal showModal={showModal} setShowModal={setShowModal} {...byow} />
          <ServicesIcon src={byowp} />
          <ServicesH2>BYOW</ServicesH2>
          <ServicesP>Randomly generated explorable worlds!</ServicesP>
        </ServicesCard>
        <ServicesCard onClick={openModal}>
          <Modal showModal={showModal} setShowModal={setShowModal} {...erisc} />
          <ServicesIcon src={eriscp} />
          <ServicesH2>ERISC</ServicesH2>
          <ServicesP>
            C++ based compiler, able to read and output .txt files
          </ServicesP>
        </ServicesCard>
        <ServicesCard onClick={openModalU}>
          ...
          <ServicesP>
            Double ended queues, <i>turn your sound on </i>
          </ServicesP>
        </ServicesCard>
        <ServicesCard onClick={openModal}>
          <Modal showModal={showModal} setShowModal={setShowModal} {...dco} />
          <ServicesIcon src={dcop} />
          <ServicesH2>2048</ServicesH2>
          <ServicesP> The core logic of the famous game, in java!</ServicesP>
        </ServicesCard>
      </ServicesWrapper>
    </ServicesContainer>
  );
